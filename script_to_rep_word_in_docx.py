...
def main():
    docx_file_path = 'yourfile.docx'
    output_file_path = 'result.docx'
   #variable names are words to be replaced
   #remove $ if there is not present before variable name and also remove brackets 
    variables = {
    ...
    template_document = Document(docx_file_path)
